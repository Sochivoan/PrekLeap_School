...
@section('my_admin')
                    <div class="title-block">
                        <h3 class="title">Add AboutUs<span class="sparkline bar" data-type="bar"></span>
                        </h3>
                    </div>
                    <form name="item" action="{{ route('dashaboutus.store')}}" method="POST" enctype="multipart/form-data">
                    @csrf
                        <div class="card card-block">
                            ...
                            <div class="form-group row">
                                <label class="col-sm-2 form-control-label text-xs-right">AboutUs Description: </label>
                                  <div class="col-sm-10">
                                     <textarea class="form-control"  name="description" id="description"  rows="5" id="comment"></textarea>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-2 form-control-label text-xs-right">AboutUs Images:</label>
                                <div class="col-sm-10">
