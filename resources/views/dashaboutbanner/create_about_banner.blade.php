...
@section('my_admin')
        <div class="title-block">
            <h3 class="title"> Add About Banner <span class="sparkline bar" data-type="bar"></span>
            </h3>
        </div>
        <form name="item" action="{{ route('dashaboutbanner.store')}}" method="POST" enctype="multipart/form-data">
            @csrf
