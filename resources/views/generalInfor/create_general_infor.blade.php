...
@section('my_admin')
                    ...
                    <form name="item" action="{{ route('generalInfor.store')}}" method="POST" enctype="multipart/form-data">
                    @csrf
                        <div class="card card-block">
                            <div class="form-group row">
                                <label class="col-sm-2 form-control-label text-xs-right">School-Telephone:</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control boxed" name="school_tel" id="school_tel" placeholder="">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-2 form-control-label text-xs-right">School-Mobile:</label>
                                  <div class="col-sm-10">
                                    <input type="text" class="form-control boxed" name="school_mobile" id="school_mobile" placeholder="">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-2 form-control-label text-xs-right">School-Email:</label>
                                  <div class="col-sm-10">
                                    <input type="text" class="form-control boxed" name="school_email" id="school_email" placeholder="">
                                </div>
                            </div>
                            <div class="form-group row">
