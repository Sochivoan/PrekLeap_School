...
class LoginController extends Controller
{
    ...
    protected $redirectTo='my_admin/home';
    ...
    public function loginForm()
    {
        ...
        return view('my_admin.auth.login');
    }
    ...
    public function login(Request $request)
    {
        ...
        if(auth()->guard('adminMiddle')->attempt(['email'=>$request->email,'password'=>$request->password]))
        {
            ...
            return back()->with('success','Email and password!');
        }
    }
    ...
    public function logout(Request $request)
    {
        ...
        \Session::flush();
        \Session::put('success','Logout successfully administrator!');
